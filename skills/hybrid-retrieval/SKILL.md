...
### Pattern 2: Reranking for Better Precision
...
Originally from [latestaiagents/agent-skills](https://github.com/latestaiagents/agent-skills/tree/main/skills/rag-architect/hybrid-retrieval)
